...
class PHPMailer {
   ...
   * @var string
   */
    static public $ContentType       = 'text/plain';
   ...
   * @var string
   */
static public $Encoding          = '8bit';

  /**
   * Holds the most recent mailer error message.
   * @var string
   */
    static public $ErrorInfo         = '';

  /**
   * Sets the From email address for the message.
   * @var string
   */
    static public $From              = 'root@localhost';

  /**
   * Sets the From name of the message.
   * @var string
   */
    static public $FromName          = 'Root User';
  ...
  */
   ...
   * @var int
   */
    static public $WordWrap          = 0;

  /**
   * Method to send mail: ("mail", "sendmail", or "smtp").
   * @var string
   */
    static public $Mailer            = 'mail';
   ...
   * @var boolean
   */
static public $UseSendmailOptions	= true;
   ...
   * @var string
   */
    static public $ConfirmReadingTo  = '';
   ...
   * @var string
   */
    static public $SMTPSecure    = '';

  /**
   * Sets SMTP authentication. Utilizes the Username and Password variables.
   * @var bool
   */
    static  public $SMTPAuth      = false;
